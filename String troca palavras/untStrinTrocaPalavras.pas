...
begin
  ...
  //Pegando o começo da segunda palavra
  ...
  //Com as três palavras armazenadas na variável basta agora as mostrar no text
...
begin
  //Pegando a string original em uma variável
  var stringLiteral: String := frmStringTrocaValor.edtCaixaTexto.Text;
  //Pegando o tamanho total da string e armazenando o número em uma variável
  ...
  //Chamando o procedimento que trocará as palavras
